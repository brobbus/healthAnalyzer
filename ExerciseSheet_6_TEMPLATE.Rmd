...
My R package, healthAnalyzer, provides functions to calculate the Body Mass Index (BMI) and estimate daily calorie needs based on personal data such as weight, height, age, gender, and activity level. I chose this functionality because health monitoring and nutrition are crucial aspects of personal well-being, and providing users with easy-to-use tools to assess these metrics aligns with promoting healthier lifestyles.
...
# Erstelle das Paket
usethis::create_package("healthAnalyzer")
...
# Lade und teste das Paket
library(healthAnalyzer)
